...
class TestMultilineParserSchemas(unittest.TestCase):
    """
        Test multi-line results from parser comply with schema.
    """
    def setUp(self):
        """
    ...
    def test_getting_pythonish_string(self):
        ...
        # Then I the results match the pythonish_string schema
        schemas.validate(
            data=result,
            schema_name='pythonish_string',
        )
    ...
    def test_get_one_row_one_cell_table(self):
        ...
        # Then I the results match the table schema
        schemas.validate(
            data=result,
            schema_name='table',
        )
    ...
    def test_get_multiline_arg_table(self):
        ...
        # Then I the results match the multiline_arg schema
        schemas.validate(
            data=result,
            schema_name='multiline_arg',
        )
    ...
    def test_get_leading_comment_with_blank_line(self):
        ...
        # Then I the results match the comments_and_space schema
        schemas.validate(
            data=result,
            schema_name='comments_and_space',
        )
    ...
    def test_get_space_non_whitespace(self):
        ...
        # Then I the results match the space schema
        schemas.validate(
            data=result,
            schema_name='space',
        )
    ...
    def test_get_leading_tag_with_blank_line(self):
        ...
        # Then I the results match the tags schema
        schemas.validate(
            data=result,
            schema_name='tags',
        )
