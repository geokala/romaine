...
class TestStepsParser(unittest.TestCase):
    ...
    def test_getting_raw_step(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output('step/basic_expected', input_data),
        )
    ...
    def test_getting_commented_step(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output('step/commented_expected', input_data),
        )
    ...
    def test_get_step_with_divorced_multiline_arg(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output(
                'step/with_space_then_string_expected',
                input_data,
            ),
        )
