...
class TestHeaderParser(unittest.TestCase):
    ...
    def test_just_header(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output('header/basic_expected', input_data),
        )
    ...
    def test_header_with_scenario_outline_and_noise(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output(
                'header/with_scenario_outline_expected',
                input_data,
            ),
        )
    ...
    def test_header_with_background_and_noise(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output(
                'header/with_background_expected',
                input_data,
            ),
        )
    ...
    def test_no_header_from_nothing(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output('header/empty_expected', input_data),
        )
