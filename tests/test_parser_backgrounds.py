...
class TestBackgroundsParser(unittest.TestCase):
    ...
    def test_basic_background(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output('background/basic_expected', input_data),
        )
    ...
    def test_background_with_description(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output(
                'background/with_description_expected',
                input_data,
            ),
        )
    ...
    def test_background_with_comment(self):
        ...
        self.assertEqual(
            result,
            common.get_parser_output(
                'background/with_comment_expected',
                input_data,
            ),
        )
